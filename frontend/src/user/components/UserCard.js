...
const UserCard = () => {
  ...
  <div className="GameImg">
    ...
    <div className="Gfooter">
      ...
      <span className="Stars"><svg preserveAspectRatio="xMidYMid meet" viewBox="0 0 50.000000 50.000000" height="50.000000pt" width="50.000000pt" version="1.0" xmlns="http://www.w3.org/2000/svg" class="StarIcon">
    ...
    <g stroke="none" fill="#f8df00" transform="translate(0.000000,50.000000) scale(0.100000,-0.100000)">
